...
def test_playground_sklearn():
    ...
    # In this case we use sklearn's Column transformer in our preprocessor
    # function
...
def test_playground_keras():
    ...
    # Here is a pre-designed preprocessor, but you could also build your own
    # to prepare the data differently
    def preprocessor(image_filepath, shape=(192, 192)):
        ...
        # cv2 reads in images in order of blue green and red, we reverse the
        # order for ML.
        ...
        X = np.array(img)
        # Expand dims to add "1" to object shape [1, h, w, channels] for keras
        # model.
    ...
    # Generate filenames
    file_names = [
        ('flower_competition_data/test_images/' +
         str(i) +
         '.jpg') for i in range(
            1,
            735)]
    ...
    # One-hot encode y_train labels (y_train.columns used to generate
    # prediction labels below)
    import pandas as pd
    ...
    # example url from deployed playground: apiurl=
    # "https://123456.execute-api.us-east-1.amazonaws.com/prod/m
