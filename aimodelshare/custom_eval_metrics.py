...
def export_eval_metric(
    ...
    """
    # evaluation metric fxn should always be named "eval_metric" to work
    ...
    try:
        ...
        function_objects = list(
            inspect.getclosurevars(eval_metric_fxn).globals.keys())
        ...
        savedevalmetricobjectslist = list(
            map(savetopickle, function_objects_nomodules))

        # take savedpreprocessorobjectslist pkl files saved to tempdir to
        # zipfile
        import pickle
        import string
