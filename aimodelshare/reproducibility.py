...
def export_reproducibility_env(seed, directory, mode="gpu"):
    ...
    return print(
        "Your reproducibility environment is now saved to 'reproducibility.json'")
...
def import_reproducibility_env_from_competition_model(
        apiurl, version, submission_type):
    ...
    if all(["username" in os.environ,
        ...
        return print(
            "Credentials not found. Please provide credentials with set_credentials().")
...
def import_reproducibility_env_from_model(apiurl):
    if all(["AWS_ACCESS_KEY_ID_AIMS" in os.environ,
        ...
        return print(
            "'Instantiate Model' unsuccessful. Please provide credentials with set_credentials().")
