...
def get_auth_head(auth_url, registry, repository):  # to do with auth
    return get_auth_head_no_aws_auth(
        ...
        registry,
        repository,
        'application/vnd.docker.distribution.manifest.v2+json')  # no aws auth
...
def import_quickstart_data(tutorial, section="modelplayground"):
    ...
    if section == "modelplayground":
        ...
        if tutorial == "clickbait":
            ...
            clickbait = pd.read_csv(
                'quickstart_clickbait_materials/clickbait_data',
                sep="\n",
                header=None)
            ...
            not_clickbait = pd.read_csv(
                'quickstart_clickbait_materials/non_clickbait_data',
                sep="\n",
                header=None)
    ...
    if section == "competition":
        ...
        if tutorial == "dogs":
            ...
            folders = [
                'quickstart_dog_breed_competition/dog_breed_competition_data/test_images',
